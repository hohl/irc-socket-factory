...
declare
function beforeEach(name:string, action:() => void):void;

declare
function beforeEach(name:string, action:(done:MochaDone) => void):void;
...
declare
function afterEach(name:string, action:() => void):void;

declare
function afterEach(name:string, action:(done:MochaDone) => void):void;
